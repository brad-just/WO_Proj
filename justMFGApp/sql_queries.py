def build_sql_query(department, field=None, sort_dir=None):
    ...
    custom_component = """AND dbo.tmfMfItemClass_HAI.MnfItemClassID LIKE '%CUST%'
    ...
    general_component = """AND (dbo.tmfMfItemClass_HAI.MnfItemClassID LIKE '%CUST%' OR dbo.tmfMfItemClass_HAI.MnfItemClassID LIKE '%BOWL%')"""
